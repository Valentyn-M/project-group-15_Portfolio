...
const projects = [
	{
		...
		imageMob: `${basePath}/img/my-projects/mobile/foto-1-mob-1x.jpg`,
		imageMob2x: `${basePath}/img/my-projects/mobile/foto-1-mob-2x.jpg`,
		imageTab: `${basePath}/img/my-projects/tablet/foto-1-tab-1x.jpg`,
		imageTab2x: `${basePath}/img/my-projects/tablet/foto-1-tab-2x.jpg`,
		imagePc: `${basePath}/img/my-projects/pc/foto-1-pc-1x.jpg`,
		imagePc2x: `${basePath}/img/my-projects/pc/foto-1-pc-2x.jpg`,
